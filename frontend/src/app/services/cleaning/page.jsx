          ...
          >
            ...
            <div className="detail-cols grid grid-cols-2 gap-3 mb-[10px]">
              ...
              >
                ...
                <label className="text-[12px] block mb-[6px]" style={{ color: "var(--nav-text-muted)" }}>Cleaning</label>
                <select
                  value={cleaningType}
                ...
                <label className="text-[12px] block mb-[6px]" style={{ color: "var(--nav-text-muted)" }}>Property Type</label>
                <select
                  value={propertyType}
              ...
              >
                ...
                <label className="text-[12px] block mb-[6px]" style={{ color: "var(--nav-text-muted)" }}>Preferred Time</label>
                <select
                  value={preferredTime}
                ...
                <label className="text-[12px] block mb-[6px]" style={{ color: "var(--nav-text-muted)" }}>Frequency</label>
                <select
                  value={frequency}
